...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user'], name='like_like_user_id_8d20f3_idx'), models.Index(fields=['post'], name='like_like_post_id_95b0ca_idx'), models.Index(fields=['created_at'], name='like_like_created_1b870d_idx')],
